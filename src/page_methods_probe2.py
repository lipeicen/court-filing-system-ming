    ...
    with sync_playwright() as p:
        ...
        info = page.evaluate("""() => {
            ...
            return {
                ...
                typeDataList0: v.typeDataList[0] ? Object.keys(v.typeDataList[0]) : null,
                typeDataListLen: v.typeDataList.length,
                firstItem: v.typeDataList[0] ? JSON.stringify(v.typeDataList[0]) : null
            };
        }""")
