...
with sync_playwright() as p:
    ...
    # set xzfy value to 110000 and reload
    res = popup.evaluate("""() => {
        function findXzfy(v) {
            if (!v) return null;
    ...
    print('after', res2)
    popup.screenshot(path=str(SAVE_DIR / 'court_beijing6.png'), full_page=True)
    with open(SAVE_DIR / 'court_beijing6.html','w',encoding='utf-8') as f: f.write(popup.content())
    print('saved')
    browser.close()
