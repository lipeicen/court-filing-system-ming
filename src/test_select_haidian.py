...
with sync_playwright() as p:
    ...
    popup.screenshot(path=str(SAVE_DIR / 'court_selected_haidian.png'), full_page=True)
    with open(SAVE_DIR / 'court_selected_haidian.html','w',encoding='utf-8') as f: f.write(popup.content())
    print('saved')
    browser.close()
