...
def main():
    ...
    with sync_playwright() as p:
        ...
        # direct navigate to the URL toZxla would open
        url = "https://zxfw.court.gov.cn/zxfw/index.html#/pagesWsla/common/wsla/index?ajlx=1501_000001-0301&ajlxMc=民事一审"
        page.goto(url, wait_until="domcontentloaded")
        wait(5)
        print('url', page.url)
        with open(SAVE_DIR / 'direct_wsla.html', 'w', encoding='utf-8') as f:
            f.write(page.content())
        page.screenshot(path=str(SAVE_DIR / 'direct_wsla.png'), full_page=True)
        # find xzfy
        xzfy = page.evaluate("""() => {
        ...
        with open(SAVE_DIR / 'direct_wsla_state.json', 'w', encoding='utf-8') as f:
